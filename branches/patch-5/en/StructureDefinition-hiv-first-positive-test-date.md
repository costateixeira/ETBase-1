# Date of First HIV Positive Test - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-hiv-first-positive-test-date.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/hiv-first-positive-test-date",
  "version" : "0.9.0",
