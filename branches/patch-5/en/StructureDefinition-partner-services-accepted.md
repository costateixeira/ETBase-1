# Accepted social network-based/partner services - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-partner-services-accepted.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/partner-services-accepted",
  "version" : "0.9.0",
