# HIV Diagnosis Facility - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-hiv-diagnosis-facility-observation.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/hiv-diagnosis-facility-observation",
  "version" : "0.9.0",
