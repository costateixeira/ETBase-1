# VMMC Adverse Events - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-vmmc-adverse-event-observation.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/vmmc-adverse-event-observation",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/core/ValueSet/vmmc-adverse-event-severity-vs"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/core/ValueSet/vmmc-adverse-event-timing-vs"
      }
    }]
  }
}
