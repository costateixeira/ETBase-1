# Mycoplasma genitalium Test Type Observation - Ethiopia Base Implementation Guide v0.9.0
...
* Examples for this Profile: [Observation/ExampleMycoplasmaGenitaliumTestType](Observation-ExampleMycoplasmaGenitaliumTestType.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-mycoplasma-genitalium-test-type-observation.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/mycoplasma-genitalium-test-type-observation",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/core/ValueSet/mycoplasma-genitalium-test-type-vs"
      }
    },
    {
    ...
    {
      "id" : "Observation.component:otherSTITestSpecify.code",
      "path" : "Observation.component.code",
      "patternCodeableConcept" : {
        "coding" : [{
          "system" : "http://fhir.et/core/CodeSystem/observation-component-specify-cs",
