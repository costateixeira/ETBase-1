# HIVTransmissionRouteObservation - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-hiv-transmission-route.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/hiv-transmission-route",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/core/ValueSet/hiv-transmission-route-vs"
      }
    }]
  }
}
