# Syphilis Testing and Treatment - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-syphilis-testing-treatment-observation.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/syphilis-testing-treatment-observation",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/core/ValueSet/syphilis-test-result-vs"
      }
    },
    {
