# Clinical Enquiry for Intimate Partner Violence (IPV) - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-ipv-clinical-enquiry.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/ipv-clinical-enquiry",
  "version" : "0.9.0",
