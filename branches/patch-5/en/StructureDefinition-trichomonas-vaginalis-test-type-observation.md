# Trichomonas vaginalis Test Type Observation - Ethiopia Base Implementation Guide v0.9.0
...
* Examples for this Profile: [Observation/ExampleTrichomonasVaginalisTestType](Observation-ExampleTrichomonasVaginalisTestType.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-trichomonas-vaginalis-test-type-observation.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/trichomonas-vaginalis-test-type-observation",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/core/ValueSet/trichomonas-vaginalis-test-type-vs"
      }
    },
    {
