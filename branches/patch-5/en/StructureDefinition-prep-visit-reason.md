# Reason for PrEP Visit - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-prep-visit-reason.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/prep-visit-reason",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://fhir.et/core/StructureDefinition/prep-visit-reason"
    },
    {
