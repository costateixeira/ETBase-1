# PartnerHIVTestOrderedObservation - Ethiopia Base Implementation Guide v0.9.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.core|current/StructureDefinition/StructureDefinition-partner-hiv-test-ordered.json)
...
```json
{
  ...
  "url" : "http://fhir.et/core/StructureDefinition/partner-hiv-test-ordered",
  "version" : "0.9.0",
