...
* [MaritalStatus](http://terminology.hl7.org/7.2.0/CodeSystem-v3-MaritalStatus.html): [ETMaritalStatusVS](ValueSet-marital-status-vs.md), [ETPatient](StructureDefinition-ETPatient.md) and [Patient/ETpatientEx](Patient-ETpatientEx.md)
