# Testing - Ethiopia Base Implementation Guide v0.9.0
...
1. Navigate to http://localhost:8087 e.g.[http://localhost:8087](http://localhost:8087)
...
1. From the same folder, run`docker-compose up -d`
1. Navigate to http://localhost:8087 e.g.[http://localhost:8080](http://localhost:8080)
